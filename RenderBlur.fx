...
float4 PS(VS_OUTPUT input) : SV_Target
{
	...
	color += shaderTexture.Sample(samLinear, input.texCoord1) * weight4;
	color += shaderTexture.Sample(samLinear, input.texCoord2) * weight3;
	color += shaderTexture.Sample(samLinear, input.texCoord3) * weight2;
	color += shaderTexture.Sample(samLinear, input.texCoord4) * weight1;
	color += shaderTexture.Sample(samLinear, input.texCoord5) * weight0;
	color += shaderTexture.Sample(samLinear, input.texCoord6) * weight1;
	color += shaderTexture.Sample(samLinear, input.texCoord7) * weight2;
	color += shaderTexture.Sample(samLinear, input.texCoord8) * weight3;
	color += shaderTexture.Sample(samLinear, input.texCoord9) * weight4;
